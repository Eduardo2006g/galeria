...
public class PhotoActivity extends AppCompatActivity {
    ...
    // Lida com a seleção de itens no menu de opções
    @Override
    ...
    // Método que compartilha a foto
    void sharePhoto() {
        // Cria uma URI para a foto usando o FileProvider
        Uri photoUri = FileProvider.getUriForFile(PhotoActivity.this, "pereira.ferreira.galeria2.fileprovider", new File(photoPath));
