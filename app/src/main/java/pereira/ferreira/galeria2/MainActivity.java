package pereira.ferreira.galeria2;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Configura o RecyclerView e define o adapter
        RecyclerView rvGallery = findViewById(R.id.rvGallery);
        rvGallery.setAdapter(mainAdapter);

        // calculo de quantas colunas de fotos cabem na tela do celular com base no width
        float w = getResources().getDimension(R.dimen.itemWidth);
        int numberOfColumns = Util.calculateNoOfColumns(MainActivity.this, w);

        //  configuram o RecycleView para exibir as fotos em GRID, respeitando o número máximo de colunas calculado
    ...
    // Método para criar um arquivo que vai guardar a imagem é feita pelo método
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == RESULT_TAKE_PICTURE) {
            if (resultCode == Activity.RESULT_OK) {
                ...
                // Se der certo, exclui o arquivo criado
